...
var passLength= prompt('Please enter a number between 8 and 128 to indicate how many characters you wish your password to have');

while(passLength< 8 || passLength >128){
    passLength= prompt('Invalid password length. Please try again');
}

var specialChars = confirm('Click "OK" if you wish to include SPECIAL characters');
var lowerChars = confirm('Click "OK" if you wish to include LOWERCASE characters');
var upperChars = confirm('Click "OK" if you wish to include UPPERCASE characters');
